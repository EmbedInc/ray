...
%ifdef streams_$inserted %then %else
  %include '/cognivision_links/sys_ins/streams.ins.pas';
  %var streams_$inserted %endif
...
begin
  ...
  backg_color.col.red := 0.0;
  backg_color.col.grn := 0.0;
  backg_color.col.blu := 0.0;
  ...
  visprop[n_vsp].diff_on := true;
  visprop[n_vsp].diff_col.red := 0.7;
  visprop[n_vsp].diff_col.grn := 0.7;
  ...
  string_appends (fnam, 'test2');      {set generic name of output file}
